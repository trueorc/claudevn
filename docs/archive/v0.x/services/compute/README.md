...
The Compute Engine is the agent execution runtime for the ClaudeVN platform. It runs agent processes, manages their lifecycle, handles tool invocations, and integrates with LLM providers.
